...
/* Setup Mixpanel */
if(__DEV__) {
  Mixpanel.sharedInstanceWithToken('f4fb10232c1cd217ff0429d0f7b4a794');
} else {
  Mixpanel.sharedInstanceWithToken('f526121fd6dc331ee2bfbd4183a4eacf');
}
...
import ViewAllImages from './screens/ViewAllImages';
...
const TasvirNavigator = StackNavigator({
  ...
  ViewAllImages: { screen: ViewAllImages }
}, {
